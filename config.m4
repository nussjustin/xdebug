...
if test "$PHP_XDEBUG" != "no"; then
  ...
  XDEBUG_TRACING_SOURCES="src/tracing/trace_computerized.c src/tracing/trace_html.c src/tracing/trace_textual.c src/tracing/trace_noop.c src/tracing/trace_flamegraph.c src/tracing/tracing.c"
